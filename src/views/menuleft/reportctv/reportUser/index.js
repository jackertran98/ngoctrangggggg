            ...
            <View >
                <View style={{ padding: 10 }}>
                    <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{ fontWeight: '500' }}>Tên CTV: {authUser.FULL_NAME}</Text>
                        <Text style={{ fontWeight: '500',width:sizeHeight(25) }}>Mã user: {authUser.USERNAME}</Text>
                    </View>
                    <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{ fontWeight: '500' }}>Số điện thoại: {authUser.MOBILE}</Text>
                        <Text style={{ fontWeight: '500',width:sizeHeight(25) }}>Email: {authUser.EMAIL}</Text>
                    </View>
