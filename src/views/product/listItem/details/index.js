...
class DetailProducts extends Component {
        ...
        [
          {
            text: "KHÔNG CÓ GIÁ SP",
            onPress: () => {
              Clipboard.setString(`https://f5sell.com/catalog?v=536&s=ABC123&c=${data.SUB_ID}&ctvid=${this.props.authUser.USER_CODE}&p=${data.CODE_PRODUCT}`)
            },
            style: "default",
          },
          {
            text: "HIỂN THỊ GIÁ SP",
            onPress: () => {
              Clipboard.setString(`https://f5sell.com/catalog?s=ABC123&c=${data.SUB_ID}&ctvid=${this.props.authUser.USER_CODE}&p=${data.CODE_PRODUCT}`)
            },
            style: "default",
          }
        ],
  ...
  render() {
    ...
    console.log("aaaaaaaaaaaaaaaaa", this.props.listItem);

    console.log("this is data status", status);
    var color = inside ? "#4a8939" : "#F5F5F5";
    var color2 = inside ? "#F5F5F5" : "#4a8939";
