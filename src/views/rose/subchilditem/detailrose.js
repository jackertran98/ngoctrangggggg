    ...
    render() {
        ...
        return (
            <View >
                ...
                <View style={{ width: sizeWidth(100), height: sizeHeight(5), backgroundColor: '#CECCCD', justifyContent: 'center', paddingLeft: 10 }}>
                ...
                <View style={{ zIndex: -1 }}>
                    {data_tt && data_tt.length == 0 ? <View style={{ height: sizeHeight(30), flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: -1 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderTopColor: 'gray', borderTopWidth: 1, padding: 10 }}>
                            <View >
                                <Text style={{lineHeight:20}}>{val.UPDATE_TIME}</Text>
                                <Text style={{lineHeight:20}}>{val.COMMENTS}</Text>
